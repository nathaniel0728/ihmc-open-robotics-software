...
public class SwingAngularMomentumTrajectory implements AngularMomentumTrajectory
{
   ...
   public SwingAngularMomentumTrajectory(String namePrefix, YoVariableRegistry registry, ReferenceFrame referenceFrame, int maxNumberOfWaypoints)
   {
